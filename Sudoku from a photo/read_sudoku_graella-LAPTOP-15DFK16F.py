...
img = preparaimg(sudoku_a)
edges = identify_edges(img)
contours = detectacontorns(edges)
contours = cantonades(contours[0])
img = retallacontorns(sudoku_a, contours)
draw_contours(sudoku_a, img)
