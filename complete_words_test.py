...
def create_train_completewords(csv, directorio_destino):
    ...
    for line in lines:
        ...
        imagen_path = os.path.join('/home/xnmaster/XNAPproject-grup_08/archive/test_v2/test', imagen_path)
...
# Ejemplo de uso
create_train_completewords('/home/xnmaster/XNAPproject-grup_08/archive/written_name_test_v2.csv', '/home/xnmaster/XNAPproject-grup_08/words_segmented_test')
